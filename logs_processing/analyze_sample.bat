...
REM Windows port of analyze_sample.sh:
REM   1. mvn package the Scala Spark job
REM   2. spark-submit it locally against the unpacked sample bundles
REM
REM Configurable via MODPACK_VER (default MP_AUTOPLAY_VP_5_2_3).
REM Reads input from   data\<MODPACK_VER>\unpacked\sample
...
echo.
echo === spark-submit ===
set "LOG=%SCRIPT_DIR%analyze_sample.log"
echo Logging to %LOG%
