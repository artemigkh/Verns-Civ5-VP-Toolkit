# 10: Religious-action Sankey across 5 stages.
#
...
#
# Outputs:
#   10a_religion_sankey.png   light theme
#   10b_religion_sankey.png   dark theme

source("r_scripts/common.R")

# --- Bad-game filter (truncation + roster mismatch). ----------------------
    ...
    ggplot() +
        ...
        theme(
            ...
            plot.caption     = element_text(
                color = if (identical(bg, IPSUM_VP_DARK_BG)) "grey60" else "grey25",
                size = 11, hjust = 1, face = "italic"),
...
p_e <- build_plot(IPSUM_VP_BG,      "grey20",         theme_report,
                  ribbon_mode = "aligned")
save_plot(p_e, "10e_religion_sankey_aligned", width = 14, height = 9)

p_f <- build_plot(IPSUM_VP_DARK_BG, IPSUM_VP_DARK_FG, theme_report_dark,
                  ribbon_mode = "aligned")
save_plot_dark(p_f, "10f_religion_sankey_aligned", width = 14, height = 9)
save_plot_dark_nocap(p_f, "10f_religion_sankey_aligned_nocap",
                     width = 14, height = 9)
