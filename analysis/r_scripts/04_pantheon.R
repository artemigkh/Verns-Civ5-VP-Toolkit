# 04: Pantheon belief frequency + win rate.
...
save_plot(pantheon_plot_a, "04a_pantheon_freq_perf",
...
save_plot_dark(pantheon_plot_b, "04b_pantheon_freq_perf",
               width = 13, height = max(6, 0.48 * nrow(pantheon_stats) + 3))
...
save_plot(pantheon_ridge_a, "04a_pantheon_turn_ridgeline",
...
save_plot_dark(pantheon_ridge_b, "04b_pantheon_turn_ridgeline",
               width = 13, height = ridge_height)
