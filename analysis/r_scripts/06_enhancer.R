# 06: Enhancer beliefs (and follower beliefs picked at enhance time)
...
build_winloss_pair <- function(theme_fn, text_color, bar_outline) {
...
save_plot(build_winloss_pair(theme_report, "grey25", "grey25"),
          "06a_enhancer_beliefs_freq_perf",
          width = plot_width, height = plot_height)
save_plot_dark(build_winloss_pair(theme_report_dark,
                                  IPSUM_VP_DARK_FG, IPSUM_VP_DARK_BG),
               "06b_enhancer_beliefs_freq_perf",
               width = plot_width, height = plot_height)
...
save_plot(build_ridge_pair(theme_report, IPSUM_VP_BG, "viridis",
                           vline_color = "white"),
          "06a_enhancer_beliefs_turn_ridgeline",
...
save_plot_dark(build_ridge_pair(theme_report_dark, IPSUM_VP_DARK_BG,
               ...
               "06b_enhancer_beliefs_turn_ridgeline",
               width = plot_width, height = ridge_height)
