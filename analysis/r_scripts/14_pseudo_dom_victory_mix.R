# 14: Pseudo-domination version of the victory mix.
...
# (`pseudo_victory == 1`), with `victory_type_aug = "Pseudo-Domination"`
# and `turn_aug` = that early threshold turn -- unless the game was
# already won by Domination, which we leave untouched.
...
# Produces:
#   14a_pseudo_dom_victory_mix.png   light theme + vtc_lut_a
#   14b_pseudo_dom_victory_mix.png   dark theme  + vtc_lut_b
...
n_pseudo  <- sum(aug_df$victory_type_aug == "Authority")
caption_text <- sprintf(
    "%d completed Civ5 VP autoplay games  -  Emperor difficulty  -  %d authority wins",
    n_games, n_pseudo)
...
save_plot(plot_a, "14a_pseudo_dom_victory_mix", width = 14, height = 7)
...
save_plot_dark(plot_b, "14b_pseudo_dom_victory_mix", width = 14, height = 7)
