# 14: Average wonders constructed per game by civilization (lollipop).
...
save_plot(build_lollipop(theme_report, "grey55", "grey20") + caption_theme("a"),
          "14a_wonders_per_civ_lollipop", width = 11, height = 12)
save_plot_dark(build_lollipop(theme_report_dark, "grey55", IPSUM_VP_DARK_FG) +
                   caption_theme("b"),
               "14b_wonders_per_civ_lollipop", width = 11, height = 12)
