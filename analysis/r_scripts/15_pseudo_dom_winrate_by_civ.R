# 15: Pseudo-domination version of the winrate-by-civ stacked bars.
...
# tiles+cities authority threshold on or before the game-ending turn AND
# the recorded victory_type is not Domination -- shifts ONE win:
#   -1 from (recorded_victor, recorded_type)
#   +1 to   (first-to-66%-civ, "Pseudo-Domination")
#
# Effects:
...
#
# Produces:
#   15a_pseudo_dom_winrate_by_civ.png   light theme + vtc_lut_a
#   15b_pseudo_dom_winrate_by_civ.png   dark theme  + vtc_lut_b
...
save_plot(
    ...
    "15a_pseudo_dom_winrate_by_civ", width = 14, height = 7)
...
save_plot_dark(
    ...
    "15b_pseudo_dom_winrate_by_civ", width = 14, height = 7)
