# 12: Era progression time -- violin per era.
...
build_era_violin <- function(theme_fn, bg, box_color, outlier_fill,
                             viridis_opt = "mako", begin = 0, end = 0.92,
                             direction = -1) {
    ...
    ggplot(era_entry_df,
        ...
        scale_fill_viridis_d(option = viridis_opt, direction = direction,
                             begin = begin, end = end,
                             guide = "none") +
        scale_y_continuous(labels = comma,
                           expand = expansion(mult = c(0.02, 0.10))) +
        labs(title = "Era Progression Times",
...
save_plot(build_era_violin(theme_report, IPSUM_VP_BG,
              ...
              caption_theme("a"),
          "12a_era_progression_time_violin", width = 13, height = 7)
# 12b uses the same inferno gradient palette as 13b for visual consistency.
save_plot_dark(build_era_violin(theme_report_dark, IPSUM_VP_DARK_BG,
                                ...
                                direction = 1) +
                   caption_theme("b"),
               "12b_era_progression_time_violin", width = 13, height = 7)
save_plot_dark_nocap(build_era_violin(theme_report_dark, IPSUM_VP_DARK_BG,
                                      box_color = "grey85", outlier_fill = "grey75",
                                      viridis_opt = "inferno",
                                      begin = 0.05, end = 0.95,
                                      direction = 1),
                     "12b_era_progression_time_violin_nocap",
                     width = 13, height = 7)
